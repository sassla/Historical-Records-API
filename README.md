...
| **parameters** | Opcional, matriz JSON | Este parámetro establece los parámetros específicos de la búsqueda. Establecer ```null``` para retornar eventos de cualquier magnitud o profundidad ocurrido en las fechas elegidas. Consultar [historical.sasslaapis.records.request.parameters]([https://github.com/sassla/Historical-Records-API/blob/main/README.md](https://github.com/sassla/Historical-Records-API/blob/main/README.md#historicalsasslaapisrecordsrequestparameters)) |
